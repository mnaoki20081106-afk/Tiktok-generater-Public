        ...
        <div className={styles.modeGrid}>
          ...
          <div className={`${styles.modeCard} ${styles.modeCardInstagram}`} data-mode-choice="instagram" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>Instagram風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 96 96" role="img">
                <defs><linearGradient id="ig-mode-gradient" x1="12" y1="88" x2="84" y2="8" gradientUnits="userSpaceOnUse"><stop stopColor="#ffd600"/><stop offset=".28" stopColor="#ff7a00"/><stop offset=".52" stopColor="#ff0169"/><stop offset=".77" stopColor="#d300c5"/><stop offset="1" stopColor="#7638fa"/></linearGradient></defs>
                <rect x="16" y="16" width="64" height="64" rx="19" fill="none" stroke="url(#ig-mode-gradient)" strokeWidth="8"/>
                <circle cx="48" cy="48" r="15" fill="none" stroke="url(#ig-mode-gradient)" strokeWidth="8"/>
          ...
          <div className={`${styles.modeCard} ${styles.modeCardInstagram}`} data-mode-choice="instagram-live" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>Instagramのライブ配信風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 96 96" role="img">
                <defs><linearGradient id="ig-live-mode-gradient" x1="12" y1="88" x2="84" y2="8" gradientUnits="userSpaceOnUse"><stop stopColor="#ffd600"/><stop offset=".28" stopColor="#ff7a00"/><stop offset=".52" stopColor="#ff0169"/><stop offset=".77" stopColor="#d300c5"/><stop offset="1" stopColor="#7638fa"/></linearGradient></defs>
                <rect x="16" y="16" width="64" height="64" rx="19" fill="none" stroke="url(#ig-live-mode-gradient)" strokeWidth="8"/>
                <circle cx="48" cy="48" r="15" fill="none" stroke="url(#ig-live-mode-gradient)" strokeWidth="8"/>
          ...
          <div className={`${styles.modeCard} ${styles.modeCardLive}`} data-mode-choice="live" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>ライブ配信サービス風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 96 96" role="img">
          ...
          <div className={`${styles.modeCard} ${styles.modeCardX}`} data-mode-choice="x" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>X（旧Twitter）風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
          ...
          <div className={`${styles.modeCard} ${styles.modeCardYoutube}`} data-mode-choice="youtube" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>YouTube風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 96 96" role="img" className={styles.youtubeLogoSvg}>
                <path fill="#FF0033" d="M22.1 25.4C17 26.1 13.8 29.4 12.8 34.7 11.7 40.4 11.5 46.2 11.5 48s.2 7.6 1.3 13.3c1 5.3 4.2 8.6 9.3 9.3C29.7 71.7 40.7 72 48 72s18.3-.3 25.9-1.4c5.1-.7 8.3-4 9.3-9.3 1.1-5.7 1.3-11.5 1.3-13.3s-.2-7.6-1.3-13.3c-1-5.3-4.2-8.6-9.3-9.3C66.3 24.3 55.3 24 48 24s-18.3.3-25.9 1.4Z"/>
                <path fill="#FFFFFF" d="M40.5 36.5 60.5 48 40.5 59.5Z"/>
              </svg>
            </span>
          </div>
          ...
          <div className={`${styles.modeCard} ${styles.modeCardTiktok}`} data-mode-choice="tiktok" data-selected="true">
            ...
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 512 512" role="img" className={styles.tiktokLogoSvg}>
                ...
                <path fill="#01F7EF" fillRule="evenodd" d="M219 199L207 199L205 198L204 199L182 200L160 206L143 214L125 226L112 238L95 260L86 278L79 301L78 314L77 315L77 337L78 338L78 346L80 356L87 377L96 394L107 409L127 428L120 420L107 398L100 379L97 366L97 360L96 359L96 329L97 328L98 317L104 297L111 282L123 264L144 243L163 230L178 223L203 216L221 215L221 200Z"/>
                <path fill="#01F7EF" fillRule="evenodd" d="M382 133L390 141L403 150L421 158L430 160L430 147L429 146L418 146L404 143L390 138Z"/>
                <path fill="#01F7EF" fillRule="evenodd" d="M332 49L265 49L264 50L264 335L260 349L252 363L242 373L233 379L221 384L211 386L192 385L188 383L185 383L180 380L192 392L203 398L219 402L231 402L247 398L261 390L270 381L279 366L283 350L283 66L284 65L334 65L333 50Z"/>
              </svg>
            </span>
          </div>
          ...
          <div className={`${styles.modeCard} ${styles.modeCardFile}`} data-mode-choice="file" data-selected="false">
            <span className={styles.modeCardCopy}>
              ...
              <span className={styles.modeCardDescription}>ファイル共有サービス風のリンクページを作成します。</span>
            </span>
            <span className={styles.modeCardIcon} aria-hidden="true">
              <svg viewBox="0 0 96 96" role="img">
                <defs><linearGradient id="folder-mode-gradient" x1="16" y1="20" x2="80" y2="80" gradientUnits="userSpaceOnUse"><stop stopColor="#4cc3ff"/><stop offset="1" stopColor="#1677ff"/></linearGradient></defs>
                <path d="M13 29c0-6 4-10 10-10h18l8 9h24c6 0 10 4 10 10v31c0 6-4 10-10 10H23c-6 0-10-4-10-10V29Z" fill="url(#folder-mode-gradient)"/>
